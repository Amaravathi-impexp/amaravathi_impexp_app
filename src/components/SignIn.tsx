...
export function SignIn({ onClose, onSwitchToSignUp, onSignInSuccess }: SignInProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Store token (mock API already stores it internally)
      ...
      // Invalid credentials
      setError(err instanceof Error ? err.message : 'Invalid username and password');
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="bg-white py-8 px-4 shadow-lg sm:rounded-lg sm:px-10">
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <button
                  type="button"
                  className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded shadow-sm bg-white hover:bg-gray-50"
                >
